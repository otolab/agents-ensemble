...
> **参照:** エージェント・人間向けの PR レビュー指針。技術構成の正本は [architecture.md](../architecture.md)。
...
| 利用者向けドキュメント | CLI 変更・出力変更は [README.md](../../README.md) または [docs/cli/README.md](../cli/README.md) に反映（architecture が README を参照している場合は必須） |
